...
const vegetacionHandler = (function() {
    ...
    // URLs de fallback para mini-tiles vegetación (siguiendo patrón elevationHandler)
    ...
    // Cargar el índice maestro al iniciar
    const cargarIndiceVegetacion = new Promise((resolve, reject) => {
        ...
        const urls = [
            ...
            ...VEGETATION_FALLBACK_URLS.map(url => `${url}vegetation_master_index.json`)
        ];
